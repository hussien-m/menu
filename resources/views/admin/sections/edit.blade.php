        ...
        <form action="{{ route('sections.update',$section->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar"
                    id="name" value="{{ old('name_ar') ?? $section->name_ar }}">
                @error('name_ar')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name_he') is-invalid @enderror" name="name_he"
                    id="name" value="{{ old('name_he') ?? $section->name_he }}">
                @error('name_he')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="slug"
                    id="name" value="{{ old('name') ?? $section->slug }}">
                @error('slug')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="text-left mt-1 mp-2">
                <img id="blah" src="{{asset('images/sections/'.$section->image)}}" width="400" alt="your image" class="rounded"/>
            </div>
